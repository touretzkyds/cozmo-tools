...
class Iterate(StateMachineProgram):
    def setup(self):
        """
        ...
        # Code generated by genfsm on Mon Feb 13 00:21:32 2017:
        ...
        say3 = Say() .set_name("say3") .set_parent(self)
        ...
        saydatatrans2 .add_sources(inner_loop) .add_destinations(say3)
        
        cnexttrans1 = CNextTrans() .set_name("cnexttrans1")
        cnexttrans1 .add_sources(say3) .add_destinations(inner_loop)
        
        cnext1 = Cnext() .set_name("cnext1")
        cnext1 .add_sources(inner_loop) .add_destinations(outer_loop)
