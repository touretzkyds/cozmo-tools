...
class GoToCube(StateNode):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Mon Dec 23 18:33:02 2019:
        ...
        nulltrans8 .add_sources(print8) .add_destinations(backup_for_escape)
        ...
        nulltrans10 .add_sources(check_start2_pilot) .add_destinations(failure)
        ...
        nulltrans11 .add_sources(go_side_pilot) .add_destinations(failure)
        ...
        nulltrans12 .add_sources(reportposition2) .add_destinations(turn_to_cube1)
        ...
        nulltrans13 .add_sources(reportposition4) .add_destinations(print10)
        
        nulltrans14 = NullTrans() .set_name("nulltrans14")
        nulltrans14 .add_sources(print10) .add_destinations(approach)
        ...
        completiontrans12 .add_sources(approach) .add_destinations(statenode1)
        
        timertrans5 = TimerTrans(0.75) .set_name("timertrans5")
        timertrans5 .add_sources(statenode1) .add_destinations(reportposition5)
        ...
        nulltrans15 .add_sources(reportposition6) .add_destinations(print11)
        
        nulltrans16 = NullTrans() .set_name("nulltrans16")
        nulltrans16 .add_sources(print11) .add_destinations(turn_to_cube_1a)
        ...
        nulltrans17 .add_sources(print12) .add_destinations(exit_to_roll)
        ...
        nulltrans18 .add_sources(print13) .add_destinations(invalidatepose1)
        ...
        failuretrans18 .add_sources(check_cube_pose) .add_destinations(parentfails2)
        
        failuretrans19 = FailureTrans() .set_name("failuretrans19")
        failuretrans19 .add_sources(choose_another_side) .add_destinations(parentfails3)
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        ...
        failuretrans20 .add_sources(check_carry) .add_destinations(goto_cube)
        ...
        failuretrans21 .add_sources(goto_cube) .add_destinations(fail)
        ...
        timertrans7 = TimerTrans(0.1) .set_name("timertrans7")
        timertrans7 .add_sources(abortheadaction1) .add_destinations(raise_lift,raise_head)
        ...
        timertrans8 .add_sources(wait) .add_destinations(raise_head2)
        
        failuretrans22 = FailureTrans() .set_name("failuretrans22")
        failuretrans22 .add_sources(raise_head) .add_destinations(wait)
        
        failuretrans23 = FailureTrans() .set_name("failuretrans23")
        failuretrans23 .add_sources(raise_head2) .add_destinations(verify)
        ...
        failuretrans24 .add_sources(verify) .add_destinations(statenode2)
        
        timertrans9 = TimerTrans(0.5) .set_name("timertrans9")
        timertrans9 .add_sources(statenode2) .add_destinations(verify2)
        ...
        failuretrans25 .add_sources(verify2) .add_destinations(frustrated)
        ...
        failuretrans26 .add_sources(verify3) .add_destinations(frustrated)
        
        nulltrans23 = NullTrans() .set_name("nulltrans23")
        nulltrans23 .add_sources(set_carrying) .add_destinations(satisfied)
        ...
        nulltrans24 .add_sources(frustrated) .add_destinations(animationtriggernode1)
        ...
        failuretrans27 .add_sources(drop_lift) .add_destinations(backupmore)
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        failuretrans28 .add_sources(check_carrying) .add_destinations(backup,lookdown)
        ...
        failuretrans29 .add_sources(lookdown) .add_destinations(head_angle_wait)
        ...
        timertrans10 .add_sources(head_angle_wait) .add_destinations(check_visible)
        ...
        failuretrans30 .add_sources(check_visible) .add_destinations(lookdown2)
        
        failuretrans31 = FailureTrans() .set_name("failuretrans31")
        failuretrans31 .add_sources(lookdown2) .add_destinations(wrap_up)
        
        timertrans11 = TimerTrans(0.5) .set_name("timertrans11")
        timertrans11 .add_sources(lookdown2) .add_destinations(wrap_up)
...
class RollCube(StateNode):
    ...
    def setup(self):
        ...
        failuretrans32 .add_sources(put_arm) .add_destinations(parentfails5)
        
        failuretrans33 = FailureTrans() .set_name("failuretrans33")
        failuretrans33 .add_sources(drop) .add_destinations(parentfails6)
        
        failuretrans34 = FailureTrans() .set_name("failuretrans34")
        failuretrans34 .add_sources(back) .add_destinations(parentfails7)
        ...
        failuretrans35 .add_sources(drop,back) .add_destinations(parentfails8)
        ...
        failuretrans36 .add_sources(reset) .add_destinations(parentfails9)
...
class RollingCube(StateNode):
    ...
    def setup(self):
        ...
        failuretrans37 .add_sources(check_cube_pose) .add_destinations(fail)
        ...
        failuretrans38 .add_sources(check_orientation) .add_destinations(goto_cube)
        
        failuretrans39 = FailureTrans() .set_name("failuretrans39")
        failuretrans39 .add_sources(goto_cube) .add_destinations(print14)
        ...
        failuretrans40 .add_sources(check_cube_pose_valid) .add_destinations(setup_check_again)
        ...
        timertrans12 .add_sources(print20) .add_destinations(check_cube_pose_valid2)
        
        failuretrans41 = FailureTrans() .set_name("failuretrans41")
        failuretrans41 .add_sources(setup_check_again) .add_destinations(try_again)
        ...
        failuretrans42 .add_sources(check_cube_pose_valid2) .add_destinations(try_again)
        ...
        timertrans13 .add_sources(print21) .add_destinations(check_cube_pose_valid)
        
        failuretrans43 = FailureTrans() .set_name("failuretrans43")
        failuretrans43 .add_sources(roll1) .add_destinations(try_again)
        ...
        failuretrans44 .add_sources(roll2) .add_destinations(try_again)
        ...
        failuretrans45 .add_sources(roll3) .add_destinations(try_again)
        ...
        failuretrans46 .add_sources(try_again) .add_destinations(fail)
        
        completiontrans63 = CompletionTrans() .set_name("completiontrans63")
        completiontrans63 .add_sources(fail) .add_destinations(parentfails10)
