...
from .geometry import get_orientation_state, same_orientation
...
class GoToCube(StateNode):
    ...
    def pick_side(self, offset, use_world_map):
        ...
        if use_world_map:
            side1 = [ (x + cos(wmobj.theta)*dist), (y + sin(wmobj.theta)*dist), wrap_angle(wmobj.theta + pi)   ]
            side2 = [ (x - cos(wmobj.theta)*dist), (y - sin(wmobj.theta)*dist), wmobj.theta]
            side3 = [ (x + sin(wmobj.theta)*dist), (y - cos(wmobj.theta)*dist), wrap_angle(wmobj.theta + pi/2) ]
            side4 = [ (x - sin(wmobj.theta)*dist), (y + cos(wmobj.theta)*dist), wrap_angle(wmobj.theta - pi/2) ]
        else:
            side1 = [ (x + cos(ang)*dist), (y + sin(ang)*dist), wrap_angle(ang + pi)   ]
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Mon Nov  4 23:16:57 2019:
        ...
        successtrans4 .add_sources(exit_to_roll) .add_destinations(forward4)
        
        completiontrans14 = CompletionTrans() .set_name("completiontrans14")
        completiontrans14 .add_sources(forward4) .add_destinations(setliftheight1)
        ...
        successtrans5 .add_sources(exit_to_roll2) .add_destinations(forward5)
        
        completiontrans20 = CompletionTrans() .set_name("completiontrans20")
        completiontrans20 .add_sources(forward5) .add_destinations(setliftheight2)
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        ...
        completiontrans23 .add_sources(fetch) .add_destinations(check_carry)
        ...
        completiontrans24 .add_sources(dropobject1) .add_destinations(goto_cube)
        ...
        completiontrans25 .add_sources(goto_cube) .add_destinations(abortheadaction1)
        ...
        completiontrans26 .add_sources(raise_head) .add_destinations(raise_head2)
        
        completiontrans27 = CompletionTrans() .set_name("completiontrans27")
        completiontrans27 .add_sources(raise_lift,raise_head2) .add_destinations(verify)
        ...
        completiontrans28 .add_sources(satisfied) .add_destinations(final_raise,drop_head)
        
        completiontrans29 = CompletionTrans() .set_name("completiontrans29")
        completiontrans29 .add_sources(final_raise,drop_head) .add_destinations(parentcompletes2)
        ...
        completiontrans30 .add_sources(animationtriggernode1) .add_destinations(missed_cube)
        
        completiontrans31 = CompletionTrans() .set_name("completiontrans31")
        completiontrans31 .add_sources(missed_cube) .add_destinations(forward6)
        
        completiontrans32 = CompletionTrans() .set_name("completiontrans32")
        completiontrans32 .add_sources(forward6) .add_destinations(drop_lift,drop_head_low)
        
        completiontrans33 = CompletionTrans() .set_name("completiontrans33")
        completiontrans33 .add_sources(drop_lift) .add_destinations(backupmore)
        ...
        completiontrans34 .add_sources(backupmore,drop_head_low) .add_destinations(fail)
        
        completiontrans35 = CompletionTrans() .set_name("completiontrans35")
        completiontrans35 .add_sources(fail) .add_destinations(parentfails3)
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        completiontrans36 .add_sources(setliftheight3) .add_destinations(check_carrying)
        ...
        completiontrans37 .add_sources(backup,lookdown) .add_destinations(head_angle_wait)
        ...
        completiontrans38 .add_sources(check_visible) .add_destinations(wrap_up)
...
class RollCube(StateNode):
    ...
    def setup(self):
        ...
        forward7 = Forward(-10) .set_name("forward7") .set_parent(self)
        ...
        completiontrans39 .add_sources(put_arm) .add_destinations(drop,back)
        
        failuretrans22 = FailureTrans() .set_name("failuretrans22")
        failuretrans22 .add_sources(put_arm) .add_destinations(parentfails4)
        
        failuretrans23 = FailureTrans() .set_name("failuretrans23")
        failuretrans23 .add_sources(drop) .add_destinations(parentfails5)
        
        failuretrans24 = FailureTrans() .set_name("failuretrans24")
        failuretrans24 .add_sources(back) .add_destinations(parentfails6)
        
        completiontrans40 = CompletionTrans() .set_name("completiontrans40")
        completiontrans40 .add_sources(drop,back) .add_destinations(reset)
        
        failuretrans25 = FailureTrans() .set_name("failuretrans25")
        failuretrans25 .add_sources(drop,back) .add_destinations(parentfails7)
        
        completiontrans41 = CompletionTrans() .set_name("completiontrans41")
        completiontrans41 .add_sources(reset) .add_destinations(forward7)
        
        completiontrans42 = CompletionTrans() .set_name("completiontrans42")
        completiontrans42 .add_sources(forward7) .add_destinations(parentcompletes4)
        
        failuretrans26 = FailureTrans() .set_name("failuretrans26")
        failuretrans26 .add_sources(reset) .add_destinations(parentfails8)
        
        return self


class RollingCube(StateNode):
    def __init__(self, object=None, orientation=None, old_orientation=None):
        super().__init__()
        self.object = object
    ...
    class CheckOrientation(StateNode):
        def start(self,event=None):
            ...
            if self.parent.target_orientation == self.parent.orientation != None:
                ...
                if not self.parent.old_orientation:
                    self.parent.old_orientation = self.parent.object.pose.rotation.q0_q1_q2_q3
                    self.post_failure()
                else:
                    q1 = self.parent.old_orientation
                    q2 = self.parent.object.pose.rotation.q0_q1_q2_q3
                    if same_orientation(q1, q2):
                        print('still the same orientation')
                        self.post_failure()
                    else:
                        if self.parent.object.is_visible:
                            self.parent.old_orientation = self.parent.object.pose.rotation.q0_q1_q2_q3
                            print('roll it success')
                            self.post_completion()
                        else:
                            print('cube is not visible')
                            self.post_failure()
            else:
                self.post_failure()
    ...
    def setup(self):
        ...
        failuretrans27 .add_sources(check_cube_pose) .add_destinations(parentfails9)
        ...
        failuretrans28 .add_sources(check_orientation) .add_destinations(goto_cube)
        ...
        failuretrans29 .add_sources(goto_cube) .add_destinations(print15)
        ...
        completiontrans48 .add_sources(print18) .add_destinations(roll1)
        ...
        completiontrans49 .add_sources(print19) .add_destinations(roll2)
        ...
        completiontrans50 .add_sources(print20) .add_destinations(roll3)
        
        completiontrans51 = CompletionTrans() .set_name("completiontrans51")
        completiontrans51 .add_sources(roll1) .add_destinations(forward8)
        
        completiontrans52 = CompletionTrans() .set_name("completiontrans52")
        completiontrans52 .add_sources(forward8) .add_destinations(print21)
        ...
        failuretrans30 .add_sources(roll1) .add_destinations(try_again)
        
        completiontrans53 = CompletionTrans() .set_name("completiontrans53")
        completiontrans53 .add_sources(roll2) .add_destinations(setliftheight4)
        
        completiontrans54 = CompletionTrans() .set_name("completiontrans54")
        completiontrans54 .add_sources(setliftheight4) .add_destinations(forwardtocube1)
        
        completiontrans55 = CompletionTrans() .set_name("completiontrans55")
        completiontrans55 .add_sources(forwardtocube1) .add_destinations(roll1)
        
        failuretrans31 = FailureTrans() .set_name("failuretrans31")
        failuretrans31 .add_sources(roll2) .add_destinations(try_again)
        
        completiontrans56 = CompletionTrans() .set_name("completiontrans56")
        completiontrans56 .add_sources(roll3) .add_destinations(setliftheight5)
        
        completiontrans57 = CompletionTrans() .set_name("completiontrans57")
        completiontrans57 .add_sources(setliftheight5) .add_destinations(forwardtocube2)
        
        completiontrans58 = CompletionTrans() .set_name("completiontrans58")
        completiontrans58 .add_sources(forwardtocube2) .add_destinations(roll2)
        
        failuretrans32 = FailureTrans() .set_name("failuretrans32")
        failuretrans32 .add_sources(roll3) .add_destinations(try_again)
        ...
        failuretrans33 .add_sources(try_again) .add_destinations(fail)
        
        completiontrans59 = CompletionTrans() .set_name("completiontrans59")
        completiontrans59 .add_sources(fail) .add_destinations(parentfails10)
