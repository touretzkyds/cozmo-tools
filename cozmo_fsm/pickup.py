...
class GoToCube(StateNode):
    ...
    def setup(self):
        """
            ...
            # let monitor_cube_pose handle the failure case
        ...
        # Code generated by genfsm on Fri Dec 27 15:07:23 2019:
        ...
        nulltrans16 .add_sources(reportposition6) .add_destinations(print11)
        
        nulltrans17 = NullTrans() .set_name("nulltrans17")
        nulltrans17 .add_sources(print11) .add_destinations(turn_to_cube_1a)
        ...
        nulltrans18 .add_sources(print12) .add_destinations(exit_to_roll)
        
        failuretrans12 = FailureTrans() .set_name("failuretrans12")
        failuretrans12 .add_sources(approach) .add_destinations(failure)
        
        failuretrans13 = FailureTrans() .set_name("failuretrans13")
        failuretrans13 .add_sources(exit_to_roll) .add_destinations(forward_to_cube_1a)
        ...
        failuretrans14 .add_sources(turn_to_cube2) .add_destinations(print13)
        
        nulltrans19 = NullTrans() .set_name("nulltrans19")
        nulltrans19 .add_sources(print13) .add_destinations(invalidatepose1)
        
        nulltrans20 = NullTrans() .set_name("nulltrans20")
        nulltrans20 .add_sources(invalidatepose1) .add_destinations(failure)
        ...
        failuretrans15 .add_sources(forward_to_cube2) .add_destinations(failure)
        ...
        failuretrans16 .add_sources(turn_to_cube3) .add_destinations(failure)
        
        failuretrans17 = FailureTrans() .set_name("failuretrans17")
        failuretrans17 .add_sources(exit_to_roll2) .add_destinations(forward_to_cube3)
        ...
        nulltrans21 .add_sources(success) .add_destinations(parentcompletes1)
        
        nulltrans22 = NullTrans() .set_name("nulltrans22")
        nulltrans22 .add_sources(failure) .add_destinations(check_cube_pose)
        ...
        failuretrans18 .add_sources(choose_another_side) .add_destinations(parentfails2)
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        ...
        failuretrans19 .add_sources(check_carry) .add_destinations(goto_cube)
        ...
        nulltrans23 .add_sources(goto_cube_pilot) .add_destinations(fail)
        
        failuretrans20 = FailureTrans() .set_name("failuretrans20")
        failuretrans20 .add_sources(goto_cube) .add_destinations(fail)
        ...
        timertrans9 .add_sources(wait) .add_destinations(raise_head2)
        
        failuretrans21 = FailureTrans() .set_name("failuretrans21")
        failuretrans21 .add_sources(raise_head) .add_destinations(wait)
        
        failuretrans22 = FailureTrans() .set_name("failuretrans22")
        failuretrans22 .add_sources(raise_head2) .add_destinations(verify)
        ...
        failuretrans23 .add_sources(verify) .add_destinations(statenode3)
        
        timertrans10 = TimerTrans(0.5) .set_name("timertrans10")
        timertrans10 .add_sources(statenode3) .add_destinations(verify2)
        ...
        failuretrans24 .add_sources(verify2) .add_destinations(frustrated)
        ...
        failuretrans25 .add_sources(verify3) .add_destinations(frustrated)
        
        nulltrans24 = NullTrans() .set_name("nulltrans24")
        nulltrans24 .add_sources(set_carrying) .add_destinations(satisfied)
        ...
        failuretrans26 .add_sources(satisfied) .add_destinations(stopallmotors1)
        
        timertrans11 = TimerTrans(1) .set_name("timertrans11")
        timertrans11 .add_sources(stopallmotors1) .add_destinations(final_raise,drop_head)
        ...
        completiontrans31 .add_sources(frustrated) .add_destinations(missed_cube)
        
        failuretrans27 = FailureTrans() .set_name("failuretrans27")
        failuretrans27 .add_sources(frustrated) .add_destinations(stopallmotors2)
        
        timertrans12 = TimerTrans(1) .set_name("timertrans12")
        timertrans12 .add_sources(stopallmotors2) .add_destinations(missed_cube)
        
        completiontrans32 = CompletionTrans() .set_name("completiontrans32")
        completiontrans32 .add_sources(missed_cube) .add_destinations(forward3)
        
        completiontrans33 = CompletionTrans() .set_name("completiontrans33")
        completiontrans33 .add_sources(forward3) .add_destinations(drop_lift,drop_head_low)
        ...
        failuretrans28 .add_sources(drop_lift) .add_destinations(backupmore)
        ...
        completiontrans36 .add_sources(fail) .add_destinations(parentfails3)
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        failuretrans29 .add_sources(check_carrying) .add_destinations(backup,lookdown)
        ...
        nulltrans25 .add_sources(setobject1) .add_destinations(setnotcarrying1)
        
        nulltrans26 = NullTrans() .set_name("nulltrans26")
        nulltrans26 .add_sources(setnotcarrying1) .add_destinations(setfetching1)
        
        nulltrans27 = NullTrans() .set_name("nulltrans27")
        nulltrans27 .add_sources(setfetching1) .add_destinations(backup,lookdown)
        
        failuretrans30 = FailureTrans() .set_name("failuretrans30")
        failuretrans30 .add_sources(lookdown) .add_destinations(head_angle_wait)
        ...
        failuretrans31 .add_sources(check_visible) .add_destinations(lookdown2)
        
        failuretrans32 = FailureTrans() .set_name("failuretrans32")
        failuretrans32 .add_sources(lookdown2) .add_destinations(wrap_up)
        ...
        nulltrans28 .add_sources(wrap_up) .add_destinations(parentcompletes3)
...
class RollCube(StateNode):
    ...
    def setup(self):
        ...
        failuretrans33 .add_sources(put_arm) .add_destinations(parentfails4)
        
        failuretrans34 = FailureTrans() .set_name("failuretrans34")
        failuretrans34 .add_sources(drop) .add_destinations(parentfails5)
        
        failuretrans35 = FailureTrans() .set_name("failuretrans35")
        failuretrans35 .add_sources(back) .add_destinations(parentfails6)
        ...
        failuretrans36 .add_sources(drop,back) .add_destinations(parentfails7)
        
        completiontrans42 = CompletionTrans() .set_name("completiontrans42")
        completiontrans42 .add_sources(reset) .add_destinations(forward4)
        
        completiontrans43 = CompletionTrans() .set_name("completiontrans43")
        completiontrans43 .add_sources(forward4) .add_destinations(parentcompletes4)
        
        failuretrans37 = FailureTrans() .set_name("failuretrans37")
        failuretrans37 .add_sources(reset) .add_destinations(parentfails8)
...
class RollingCube(StateNode):
    ...
    def setup(self):
        ...
        failuretrans38 .add_sources(check_cube_pose) .add_destinations(fail)
        ...
        failuretrans39 .add_sources(check_orientation) .add_destinations(goto_cube)
        
        failuretrans40 = FailureTrans() .set_name("failuretrans40")
        failuretrans40 .add_sources(goto_cube) .add_destinations(print14)
        
        nulltrans29 = NullTrans() .set_name("nulltrans29")
        nulltrans29 .add_sources(print14) .add_destinations(try_again)
        ...
        nulltrans30 .add_sources(print15) .add_destinations(decide_roll_counts)
        ...
        failuretrans41 .add_sources(check_cube_pose_valid) .add_destinations(setup_check_again)
        
        completiontrans53 = CompletionTrans() .set_name("completiontrans53")
        completiontrans53 .add_sources(setup_check_again) .add_destinations(print20)
        ...
        failuretrans42 .add_sources(setup_check_again) .add_destinations(try_again)
        ...
        failuretrans43 .add_sources(check_cube_pose_valid2) .add_destinations(try_again)
        
        completiontrans55 = CompletionTrans() .set_name("completiontrans55")
        completiontrans55 .add_sources(roll1) .add_destinations(forward5)
        
        completiontrans56 = CompletionTrans() .set_name("completiontrans56")
        completiontrans56 .add_sources(forward5) .add_destinations(print21)
        ...
        failuretrans44 .add_sources(roll1) .add_destinations(try_again)
        ...
        failuretrans45 .add_sources(roll2) .add_destinations(try_again)
        ...
        failuretrans46 .add_sources(roll3) .add_destinations(try_again)
        ...
        failuretrans47 .add_sources(try_again) .add_destinations(fail)
        
        completiontrans63 = CompletionTrans() .set_name("completiontrans63")
        completiontrans63 .add_sources(fail) .add_destinations(parentfails9)
