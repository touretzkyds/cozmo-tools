...
class GoToCube(StateNode):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Thu Dec  5 23:04:23 2019:
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        ...
        completiontrans27 .add_sources(raise_head) .add_destinations(raise_head2)
        ...
        failuretrans15 .add_sources(verify) .add_destinations(statenode4)
        ...
        failuretrans16 .add_sources(verify2) .add_destinations(frustrated)
        ...
        failuretrans17 .add_sources(verify3) .add_destinations(frustrated)
        ...
        completiontrans32 .add_sources(missed_cube) .add_destinations(forward6)
        
        completiontrans33 = CompletionTrans() .set_name("completiontrans33")
        completiontrans33 .add_sources(forward6) .add_destinations(drop_lift,drop_head_low)
        ...
        failuretrans18 .add_sources(drop_lift) .add_destinations(backupmore)
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        failuretrans19 .add_sources(check_carrying) .add_destinations(backup,lookdown)
        ...
        failuretrans20 .add_sources(lookdown) .add_destinations(head_angle_wait)
        ...
        failuretrans21 .add_sources(check_visible) .add_destinations(lookdown2)
        
        failuretrans22 = FailureTrans() .set_name("failuretrans22")
        failuretrans22 .add_sources(lookdown2) .add_destinations(wrap_up)
...
class RollCube(StateNode):
    ...
    def setup(self):
        ...
        failuretrans23 .add_sources(put_arm) .add_destinations(parentfails5)
        
        failuretrans24 = FailureTrans() .set_name("failuretrans24")
        failuretrans24 .add_sources(drop) .add_destinations(parentfails6)
        
        failuretrans25 = FailureTrans() .set_name("failuretrans25")
        failuretrans25 .add_sources(back) .add_destinations(parentfails7)
        ...
        failuretrans26 .add_sources(drop,back) .add_destinations(parentfails8)
        
        completiontrans42 = CompletionTrans() .set_name("completiontrans42")
        completiontrans42 .add_sources(reset) .add_destinations(forward7)
        
        completiontrans43 = CompletionTrans() .set_name("completiontrans43")
        completiontrans43 .add_sources(forward7) .add_destinations(parentcompletes4)
        
        failuretrans27 = FailureTrans() .set_name("failuretrans27")
        failuretrans27 .add_sources(reset) .add_destinations(parentfails9)
...
class RollingCube(StateNode):
    ...
    def setup(self):
        ...
        failuretrans28 .add_sources(check_cube_pose) .add_destinations(parentfails10)
        ...
        failuretrans29 .add_sources(check_orientation) .add_destinations(goto_cube)
        
        failuretrans30 = FailureTrans() .set_name("failuretrans30")
        failuretrans30 .add_sources(goto_cube) .add_destinations(print14)
        ...
        failuretrans31 .add_sources(check_cube_pose_valid) .add_destinations(forward8)
        
        completiontrans53 = CompletionTrans() .set_name("completiontrans53")
        completiontrans53 .add_sources(forward8) .add_destinations(print20)
        
        timertrans13 = TimerTrans(1) .set_name("timertrans13")
        timertrans13 .add_sources(print20) .add_destinations(check_cube_pose_valid2)
        ...
        failuretrans32 .add_sources(check_cube_pose_valid2) .add_destinations(fail)
        
        completiontrans55 = CompletionTrans() .set_name("completiontrans55")
        completiontrans55 .add_sources(roll1) .add_destinations(forward9)
        
        completiontrans56 = CompletionTrans() .set_name("completiontrans56")
        completiontrans56 .add_sources(forward9) .add_destinations(print21)
        
        timertrans14 = TimerTrans(1) .set_name("timertrans14")
        timertrans14 .add_sources(print21) .add_destinations(check_cube_pose_valid)
        
        failuretrans33 = FailureTrans() .set_name("failuretrans33")
        failuretrans33 .add_sources(roll1) .add_destinations(try_again)
        ...
        failuretrans34 .add_sources(roll2) .add_destinations(try_again)
        ...
        failuretrans35 .add_sources(roll3) .add_destinations(try_again)
        ...
        failuretrans36 .add_sources(try_again) .add_destinations(fail)
