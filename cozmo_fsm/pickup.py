...
from .pilot import PilotToPose, PilotCheckStart, ParentPilotEvent
...
class GoToCube(StateNode):
    ...
    def setup(self):
        """
            ...
            go_side =PILOT=> ParentPilotEvent()
        ...
        # Code generated by genfsm on Sat Apr 14 07:29:33 2018:
        ...
        pilottrans1 .add_sources(go_side) .add_destinations(parentpilotevent1)
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        """
            goto_cube: GoToCube()
            goto_cube =PILOT=> ParentPilotEvent() =N=> ParentFails()
        ...
        pilottrans2 .add_sources(goto_cube) .add_destinations(parentpilotevent2)
        
        nulltrans5 = NullTrans() .set_name("nulltrans5")
        nulltrans5 .add_sources(parentpilotevent2) .add_destinations(parentfails3)
        
        failuretrans6 = FailureTrans() .set_name("failuretrans6")
        failuretrans6 .add_sources(goto_cube) .add_destinations(parentfails4)
