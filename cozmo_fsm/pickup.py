...
class GoToCube(StateNode):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Thu Feb  1 19:48:56 2018:
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        ...
        textmsgtrans1 .add_sources(frustrated) .add_destinations(missed_cube)
        
        completiontrans17 = CompletionTrans() .set_name("completiontrans17")
        completiontrans17 .add_sources(missed_cube) .add_destinations(forward3)
        
        completiontrans18 = CompletionTrans() .set_name("completiontrans18")
        completiontrans18 .add_sources(forward3) .add_destinations(drop_lift,drop_head_low)
        
        completiontrans19 = CompletionTrans() .set_name("completiontrans19")
        completiontrans19 .add_sources(drop_lift,drop_head_low) .add_destinations(parentfails4)
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        completiontrans20 .add_sources(setliftheight1) .add_destinations(setnotcarrying1)
        ...
        completiontrans21 .add_sources(forward4) .add_destinations(parentcompletes2)
...
class PickUpCubeForeign(StateNode):
    ...
    def setup(self):
        ...
        completiontrans22 .add_sources(goto_cube) .add_destinations(one)
        
        completiontrans23 = CompletionTrans() .set_name("completiontrans23")
        completiontrans23 .add_sources(one) .add_destinations(end)
        
        completiontrans24 = CompletionTrans() .set_name("completiontrans24")
        completiontrans24 .add_sources(end) .add_destinations(parentcompletes3)
