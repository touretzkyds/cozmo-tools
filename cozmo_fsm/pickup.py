...
class GoToCube(StateNode):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Thu Sep 12 22:37:56 2019:
        ...
        completiontrans17 .add_sources(turn_to_cube3) .add_destinations(forward_to_cube3)
        ...
        failuretrans9 .add_sources(choose_another_side) .add_destinations(parentfails2)
        
        successtrans4 = SuccessTrans() .set_name("successtrans4")
        successtrans4 .add_sources(choose_another_side) .add_destinations(droplift)
...
class RollCube(StateNode):
    ...
    def setup(self):
        """
            start: SetLiftHeight(1) =C=> Forward(35) =C=> put_arm
            ...
            {drop, back} =C=> SetLiftHeight(0) =C=> ParentCompletes()
            {drop, back} =F=> SetLiftHeight(0) =C=> ParentFails()
        """
        
        # Code generated by genfsm on Fri Oct  4 17:46:24 2019:
        
        start = SetLiftHeight(1) .set_name("start") .set_parent(self)
        forward5 = Forward(35) .set_name("forward5") .set_parent(self)
        ...
        completiontrans39 .add_sources(setliftheight2) .add_destinations(parentcompletes4)
        
        failuretrans20 = FailureTrans() .set_name("failuretrans20")
        failuretrans20 .add_sources(drop,back) .add_destinations(setliftheight3)
        
        completiontrans40 = CompletionTrans() .set_name("completiontrans40")
        completiontrans40 .add_sources(setliftheight3) .add_destinations(parentfails4)
...
class RollingCube(StateNode):
    ...
    def setup(self):
        ...
        forward9 = Forward(-30) .set_name("forward9") .set_parent(self)
        ...
        completiontrans41 .add_sources(start) .add_destinations(looker,check_cube_pose)
        
        completiontrans42 = CompletionTrans() .set_name("completiontrans42")
        completiontrans42 .add_sources(check_cube_pose) .add_destinations(check_orientation)
        
        failuretrans21 = FailureTrans() .set_name("failuretrans21")
        failuretrans21 .add_sources(check_cube_pose) .add_destinations(parentfails5)
        
        completiontrans43 = CompletionTrans() .set_name("completiontrans43")
        completiontrans43 .add_sources(check_orientation) .add_destinations(parentcompletes5)
        
        failuretrans22 = FailureTrans() .set_name("failuretrans22")
        failuretrans22 .add_sources(check_orientation) .add_destinations(goto_cube)
        ...
        failuretrans23 .add_sources(goto_cube) .add_destinations(print15)
        ...
        completiontrans44 .add_sources(goto_cube) .add_destinations(print16)
        ...
        completiontrans45 .add_sources(print17) .add_destinations(check_cube_pose)
        ...
        completiontrans46 .add_sources(print18) .add_destinations(forward6)
        
        completiontrans47 = CompletionTrans() .set_name("completiontrans47")
        completiontrans47 .add_sources(forward6) .add_destinations(roll1)
        ...
        completiontrans48 .add_sources(print19) .add_destinations(forward7)
        
        completiontrans49 = CompletionTrans() .set_name("completiontrans49")
        completiontrans49 .add_sources(forward7) .add_destinations(roll2)
        ...
        completiontrans50 .add_sources(print20) .add_destinations(forward8)
        
        completiontrans51 = CompletionTrans() .set_name("completiontrans51")
        completiontrans51 .add_sources(forward8) .add_destinations(roll3)
        
        completiontrans52 = CompletionTrans() .set_name("completiontrans52")
        completiontrans52 .add_sources(roll1) .add_destinations(forward9)
        
        completiontrans53 = CompletionTrans() .set_name("completiontrans53")
        completiontrans53 .add_sources(forward9) .add_destinations(print21)
        ...
        failuretrans24 .add_sources(roll1) .add_destinations(try_again)
        
        completiontrans54 = CompletionTrans() .set_name("completiontrans54")
        completiontrans54 .add_sources(roll2) .add_destinations(roll1)
        
        failuretrans25 = FailureTrans() .set_name("failuretrans25")
        failuretrans25 .add_sources(roll2) .add_destinations(try_again)
        
        completiontrans55 = CompletionTrans() .set_name("completiontrans55")
        completiontrans55 .add_sources(roll3) .add_destinations(roll2)
        
        failuretrans26 = FailureTrans() .set_name("failuretrans26")
        failuretrans26 .add_sources(roll3) .add_destinations(try_again)
        
        successtrans10 = SuccessTrans() .set_name("successtrans10")
        successtrans10 .add_sources(try_again) .add_destinations(check_cube_pose)
        
        failuretrans27 = FailureTrans() .set_name("failuretrans27")
        failuretrans27 .add_sources(try_again) .add_destinations(fail)
        
        completiontrans56 = CompletionTrans() .set_name("completiontrans56")
        completiontrans56 .add_sources(fail) .add_destinations(parentfails6)
