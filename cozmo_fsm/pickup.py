...
class GoToCube(StateNode):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Thu Feb  1 20:24:55 2018:
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        ...
        raise_lift = SetLiftHeight(0.7) .set_name("raise_lift") .set_parent(self)
        raise_head = SetHeadAngle(25) .set_name("raise_head") .set_parent(self)
        ...
        completiontrans14 .add_sources(raise_lift,raise_head) .add_destinations(verify)
        ...
        failuretrans7 .add_sources(verify) .add_destinations(statenode3)
        ...
        failuretrans8 .add_sources(verify2) .add_destinations(statenode4)
        ...
        failuretrans9 .add_sources(verify3) .add_destinations(frustrated)
        
        completiontrans15 = CompletionTrans() .set_name("completiontrans15")
        completiontrans15 .add_sources(satisfied) .add_destinations(final_raise,drop_head)
        
        completiontrans16 = CompletionTrans() .set_name("completiontrans16")
        completiontrans16 .add_sources(final_raise,drop_head) .add_destinations(setcarrying1)
        
        nulltrans5 = NullTrans() .set_name("nulltrans5")
        nulltrans5 .add_sources(setcarrying1) .add_destinations(parentcompletes1)
        
        completiontrans17 = CompletionTrans() .set_name("completiontrans17")
        completiontrans17 .add_sources(frustrated) .add_destinations(missed_cube)
        
        completiontrans18 = CompletionTrans() .set_name("completiontrans18")
        completiontrans18 .add_sources(missed_cube) .add_destinations(forward3)
        
        completiontrans19 = CompletionTrans() .set_name("completiontrans19")
        completiontrans19 .add_sources(forward3) .add_destinations(drop_lift,drop_head_low)
        
        completiontrans20 = CompletionTrans() .set_name("completiontrans20")
        completiontrans20 .add_sources(drop_lift) .add_destinations(backupmore)
        
        completiontrans21 = CompletionTrans() .set_name("completiontrans21")
        completiontrans21 .add_sources(backupmore,drop_head_low) .add_destinations(parentfails4)
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        remembercarriedobject1 = self.RememberCarriedObject() .set_name("remembercarriedobject1") .set_parent(self)
        ...
        setposition1 = self.SetPosition() .set_name("setposition1") .set_parent(self)
        ...
        nulltrans6 .add_sources(remembercarriedobject1) .add_destinations(setliftheight1)
        
        completiontrans22 = CompletionTrans() .set_name("completiontrans22")
        completiontrans22 .add_sources(setliftheight1) .add_destinations(setnotcarrying1)
        
        nulltrans7 = NullTrans() .set_name("nulltrans7")
        nulltrans7 .add_sources(setnotcarrying1) .add_destinations(setposition1)
        
        nulltrans8 = NullTrans() .set_name("nulltrans8")
        nulltrans8 .add_sources(setposition1) .add_destinations(forward4)
        
        completiontrans23 = CompletionTrans() .set_name("completiontrans23")
        completiontrans23 .add_sources(forward4) .add_destinations(parentcompletes2)
...
class PickUpCubeForeign(StateNode):
    ...
    def setup(self):
        ...
        completiontrans24 .add_sources(goto_cube) .add_destinations(one)
        
        completiontrans25 = CompletionTrans() .set_name("completiontrans25")
        completiontrans25 .add_sources(one) .add_destinations(end)
        
        completiontrans26 = CompletionTrans() .set_name("completiontrans26")
        completiontrans26 .add_sources(end) .add_destinations(parentcompletes3)
