...
class GoToCube(StateNode):
    ...
    def setup(self):
        """
            ...
            check_start =F=> Forward(-70) =C=> StateNode() =T(0.5)=> check_start
        ...
        # Code generated by genfsm on Tue Jan  2 15:20:54 2018:
        ...
        forward1 = Forward(-70) .set_name("forward1") .set_parent(self)
...
class PickUpCube(StateNode):
    ...
    class VerifyPickup(StateNode):
        def probe(self, im, col, row_start, row_end):
            """
            ...
            print('\nblack_thresh=',black_thresh,'  black_index=',black_index,
        ...
        def start(self,event=None):
            ...
            print('shape=',im.shape,'  one is', im[0].shape)
            print('\nColumn 140:')
            [print(im[i,140,0],' ',sep='',end='') for i in range(10,100)]
            print('\n')
            min_length = 20
            max_length = 26
            bad_runs = 0
            ...
            for col in range(100,220,20):
                run_length = self.probe(im, col, 10, 100)
