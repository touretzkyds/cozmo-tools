...
class GoToCube(StateNode):
        ...
        if orientation == ORIENTATION_SIDEWAYS:
            if self.roll_cube:
                ...
                if self.roll_target != ORIENTATION_SIDEWAYS:
                    self.side_index = 0 if self.try_number == 0 else self.side_index
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Tue Oct  1 15:08:55 2019:
...
class RollingCube(StateNode):
    ...
    def setup(self):
        """
            ...
            goto_cube: GoToCube()
            goto_cube =PILOT=> goto_cube_pilot: ParentPilotEvent() =N=> Print('goto_cube has pilot.') =N=> get_ready
            goto_cube =F=> Print('goto_cube has failed.') =N=> try_again
            goto_cube =C=> Print('goto_cube has succeeded.') =N=> get_ready
    
            get_ready: SetHeadAngle(-5) =C=> Forward(-60) =C=> StateNode() =T(1)=> decide_roll_counts
    
            decide_roll_counts: self.CheckCounts()
            decide_roll_counts =D(0)=> Print('No way to achieve from this side') =C=>check_orientation
        ...
        get_ready = SetHeadAngle(-5) .set_name("get_ready") .set_parent(self)
        forward5 = Forward(-60) .set_name("forward5") .set_parent(self)
        ...
        completiontrans35 .add_sources(check_orientation) .add_destinations(parentcompletes4)
        
        failuretrans20 = FailureTrans() .set_name("failuretrans20")
        failuretrans20 .add_sources(check_orientation) .add_destinations(goto_cube)
        ...
        nulltrans28 .add_sources(print14) .add_destinations(get_ready)
        
        failuretrans21 = FailureTrans() .set_name("failuretrans21")
        failuretrans21 .add_sources(goto_cube) .add_destinations(print15)
        ...
        completiontrans36 .add_sources(goto_cube) .add_destinations(print16)
        
        nulltrans30 = NullTrans() .set_name("nulltrans30")
        nulltrans30 .add_sources(print16) .add_destinations(get_ready)
        
        completiontrans37 = CompletionTrans() .set_name("completiontrans37")
        completiontrans37 .add_sources(get_ready) .add_destinations(forward5)
        
        completiontrans38 = CompletionTrans() .set_name("completiontrans38")
        completiontrans38 .add_sources(forward5) .add_destinations(statenode5)
        
        timertrans13 = TimerTrans(1) .set_name("timertrans13")
        timertrans13 .add_sources(statenode5) .add_destinations(decide_roll_counts)
        ...
        completiontrans39 .add_sources(print17) .add_destinations(check_orientation)
        ...
        completiontrans40 .add_sources(print18) .add_destinations(roll1)
        ...
        completiontrans41 .add_sources(print19) .add_destinations(roll2)
        ...
        completiontrans42 .add_sources(print20) .add_destinations(roll3)
        
        completiontrans43 = CompletionTrans() .set_name("completiontrans43")
        completiontrans43 .add_sources(roll1) .add_destinations(check_orientation)
        
        failuretrans22 = FailureTrans() .set_name("failuretrans22")
        failuretrans22 .add_sources(roll1) .add_destinations(try_again)
        
        completiontrans44 = CompletionTrans() .set_name("completiontrans44")
        completiontrans44 .add_sources(roll2) .add_destinations(roll1)
        
        failuretrans23 = FailureTrans() .set_name("failuretrans23")
        failuretrans23 .add_sources(roll2) .add_destinations(try_again)
        
        completiontrans45 = CompletionTrans() .set_name("completiontrans45")
        completiontrans45 .add_sources(roll3) .add_destinations(roll2)
        
        failuretrans24 = FailureTrans() .set_name("failuretrans24")
        failuretrans24 .add_sources(roll3) .add_destinations(try_again)
        
        successtrans10 = SuccessTrans() .set_name("successtrans10")
        successtrans10 .add_sources(try_again) .add_destinations(check_orientation)
        
        failuretrans25 = FailureTrans() .set_name("failuretrans25")
        failuretrans25 .add_sources(try_again) .add_destinations(fail)
        
        completiontrans46 = CompletionTrans() .set_name("completiontrans46")
        completiontrans46 .add_sources(fail) .add_destinations(parentfails4)
