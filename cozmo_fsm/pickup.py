...
class GoToCube(StateNode):
    ...
    def setup(self):
        """
            ...
            droplift =C=> Print('droplift succeeded') =N=> after_drop
            droplift =F=> Print('droplift failed') =N=> after_drop
        ...
        # Code generated by genfsm on Mon Dec 30 00:31:12 2019:
        ...
        print12 = Print("TurnToCube2: Cube Lost") .set_name("print12") .set_parent(self)
        ...
        nulltrans1 .add_sources(print1) .add_destinations(after_drop)
        
        failuretrans1 = FailureTrans() .set_name("failuretrans1")
        failuretrans1 .add_sources(droplift) .add_destinations(print2)
        
        nulltrans2 = NullTrans() .set_name("nulltrans2")
        nulltrans2 .add_sources(print2) .add_destinations(after_drop)
        
        nulltrans3 = NullTrans() .set_name("nulltrans3")
        nulltrans3 .add_sources(after_drop) .add_destinations(looker,waitlift,monitor_cube_pose)
        ...
        nulltrans4 .add_sources(print3) .add_destinations(manual_dock1)
        
        completiontrans6 = CompletionTrans() .set_name("completiontrans6")
        completiontrans6 .add_sources(manual_dock1) .add_destinations(print4)
        
        nulltrans5 = NullTrans() .set_name("nulltrans5")
        nulltrans5 .add_sources(print4) .add_destinations(manual_dock2)
        
        timertrans3 = TimerTrans(10) .set_name("timertrans3")
        timertrans3 .add_sources(manual_dock1) .add_destinations(print5)
        
        nulltrans6 = NullTrans() .set_name("nulltrans6")
        nulltrans6 .add_sources(print5) .add_destinations(pilot_check_start)
        ...
        nulltrans7 .add_sources(print6) .add_destinations(turn_to_cube1)
        ...
        failuretrans6 .add_sources(pilot_check_start) .add_destinations(print8)
        
        nulltrans9 = NullTrans() .set_name("nulltrans9")
        nulltrans9 .add_sources(print8) .add_destinations(backup_for_escape)
        ...
        nulltrans10 .add_sources(print9) .add_destinations(go_side)
        ...
        nulltrans11 .add_sources(check_start2_pilot) .add_destinations(failure)
        ...
        nulltrans12 .add_sources(go_side_pilot) .add_destinations(failure)
        ...
        nulltrans13 .add_sources(reportposition2) .add_destinations(turn_to_cube1)
        ...
        nulltrans14 .add_sources(reportposition4) .add_destinations(print10)
        
        nulltrans15 = NullTrans() .set_name("nulltrans15")
        nulltrans15 .add_sources(print10) .add_destinations(approach)
        ...
        nulltrans16 .add_sources(reportposition6) .add_destinations(turn_to_cube_1a)
        
        completiontrans13 = CompletionTrans() .set_name("completiontrans13")
        completiontrans13 .add_sources(turn_to_cube_1a) .add_destinations(print11)
        
        nulltrans17 = NullTrans() .set_name("nulltrans17")
        nulltrans17 .add_sources(print11) .add_destinations(exit_to_roll)
        ...
        failuretrans15 .add_sources(turn_to_cube2) .add_destinations(print12)
        
        nulltrans18 = NullTrans() .set_name("nulltrans18")
        nulltrans18 .add_sources(print12) .add_destinations(invalidatepose1)
        
        nulltrans19 = NullTrans() .set_name("nulltrans19")
        nulltrans19 .add_sources(invalidatepose1) .add_destinations(failure)
        ...
        nulltrans20 .add_sources(success) .add_destinations(parentcompletes1)
        
        nulltrans21 = NullTrans() .set_name("nulltrans21")
        nulltrans21 .add_sources(failure) .add_destinations(check_cube_pose)
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        """
            ...
            raise_head =C=> wait_head: AbortHeadAction() =C=> StateNode() =T(0.5)=> raise_head2
        ...
        nulltrans22 .add_sources(goto_cube_pilot) .add_destinations(fail)
        
        failuretrans22 = FailureTrans() .set_name("failuretrans22")
        failuretrans22 .add_sources(goto_cube) .add_destinations(fail)
        ...
        nulltrans23 .add_sources(set_carrying) .add_destinations(statenode6)
        ...
        completiontrans37 .add_sources(fail) .add_destinations(parentfails4)
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        completiontrans38 .add_sources(setliftheight3) .add_destinations(check_carrying)
        ...
        nulltrans24 .add_sources(setobject1) .add_destinations(setnotcarrying1)
        
        nulltrans25 = NullTrans() .set_name("nulltrans25")
        nulltrans25 .add_sources(setnotcarrying1) .add_destinations(setfetching1)
        
        nulltrans26 = NullTrans() .set_name("nulltrans26")
        nulltrans26 .add_sources(setfetching1) .add_destinations(backup,lookdown)
        ...
        completiontrans39 .add_sources(backup,lookdown) .add_destinations(head_angle_wait)
        ...
        completiontrans40 .add_sources(check_visible) .add_destinations(wrap_up)
        ...
        nulltrans27 .add_sources(wrap_up) .add_destinations(parentcompletes3)
...
class RollCube(StateNode):
    ...
    def setup(self):
        ...
        completiontrans41 .add_sources(put_arm) .add_destinations(drop,back)
        ...
        completiontrans42 .add_sources(drop,back) .add_destinations(reset)
        ...
        completiontrans43 .add_sources(reset) .add_destinations(forward4)
        
        completiontrans44 = CompletionTrans() .set_name("completiontrans44")
        completiontrans44 .add_sources(forward4) .add_destinations(parentcompletes4)
...
class RollingCube(StateNode):
    ...
    def setup(self):
        ...
        goto_cube = GoToCube() .set_name("goto_cube") .set_parent(self)
        print13 = Print('goto_cube has failed.') .set_name("print13") .set_parent(self)
        print14 = Print('goto_cube has succeeded.') .set_name("print14") .set_parent(self)
        decide_roll_counts = self.CheckCounts() .set_name("decide_roll_counts") .set_parent(self)
        print15 = Print('No way to achieve from this side') .set_name("print15") .set_parent(self)
        print16 = Print('Roll once') .set_name("print16") .set_parent(self)
        print17 = Print('Roll twice') .set_name("print17") .set_parent(self)
        print18 = Print('Roll thrice') .set_name("print18") .set_parent(self)
        ...
        print19 = Print('backing up...') .set_name("print19") .set_parent(self)
        ...
        print20 = Print('Checking the new orientation...') .set_name("print20") .set_parent(self)
        ...
        completiontrans45 .add_sources(start) .add_destinations(looker,check_cube_pose)
        
        completiontrans46 = CompletionTrans() .set_name("completiontrans46")
        completiontrans46 .add_sources(check_cube_pose) .add_destinations(check_orientation)
        ...
        completiontrans47 .add_sources(check_orientation) .add_destinations(parentcompletes5)
        
        failuretrans41 = FailureTrans() .set_name("failuretrans41")
        failuretrans41 .add_sources(check_orientation) .add_destinations(goto_cube)
        
        failuretrans42 = FailureTrans() .set_name("failuretrans42")
        failuretrans42 .add_sources(goto_cube) .add_destinations(print13)
        
        nulltrans28 = NullTrans() .set_name("nulltrans28")
        nulltrans28 .add_sources(print13) .add_destinations(try_again)
        
        completiontrans48 = CompletionTrans() .set_name("completiontrans48")
        completiontrans48 .add_sources(goto_cube) .add_destinations(print14)
        
        nulltrans29 = NullTrans() .set_name("nulltrans29")
        nulltrans29 .add_sources(print14) .add_destinations(decide_roll_counts)
        
        datatrans2 = DataTrans(0) .set_name("datatrans2")
        datatrans2 .add_sources(decide_roll_counts) .add_destinations(print15)
        
        completiontrans49 = CompletionTrans() .set_name("completiontrans49")
        completiontrans49 .add_sources(print15) .add_destinations(check_cube_pose_valid)
        
        datatrans3 = DataTrans(1) .set_name("datatrans3")
        datatrans3 .add_sources(decide_roll_counts) .add_destinations(print16)
        
        completiontrans50 = CompletionTrans() .set_name("completiontrans50")
        completiontrans50 .add_sources(print16) .add_destinations(roll1)
        
        datatrans4 = DataTrans(2) .set_name("datatrans4")
        datatrans4 .add_sources(decide_roll_counts) .add_destinations(print17)
        
        completiontrans51 = CompletionTrans() .set_name("completiontrans51")
        completiontrans51 .add_sources(print17) .add_destinations(roll2)
        
        datatrans5 = DataTrans(3) .set_name("datatrans5")
        datatrans5 .add_sources(decide_roll_counts) .add_destinations(print18)
        
        completiontrans52 = CompletionTrans() .set_name("completiontrans52")
        completiontrans52 .add_sources(print18) .add_destinations(roll3)
        
        completiontrans53 = CompletionTrans() .set_name("completiontrans53")
        completiontrans53 .add_sources(check_cube_pose_valid) .add_destinations(check_orientation)
        
        failuretrans43 = FailureTrans() .set_name("failuretrans43")
        failuretrans43 .add_sources(check_cube_pose_valid) .add_destinations(setup_check_again)
        
        completiontrans54 = CompletionTrans() .set_name("completiontrans54")
        completiontrans54 .add_sources(setup_check_again) .add_destinations(print19)
        
        timertrans17 = TimerTrans(1) .set_name("timertrans17")
        timertrans17 .add_sources(print19) .add_destinations(check_cube_pose_valid2)
        
        failuretrans44 = FailureTrans() .set_name("failuretrans44")
        failuretrans44 .add_sources(setup_check_again) .add_destinations(try_again)
        
        completiontrans55 = CompletionTrans() .set_name("completiontrans55")
        completiontrans55 .add_sources(check_cube_pose_valid2) .add_destinations(check_orientation)
        
        failuretrans45 = FailureTrans() .set_name("failuretrans45")
        failuretrans45 .add_sources(check_cube_pose_valid2) .add_destinations(try_again)
        
        completiontrans56 = CompletionTrans() .set_name("completiontrans56")
        completiontrans56 .add_sources(roll1) .add_destinations(forward5)
        
        completiontrans57 = CompletionTrans() .set_name("completiontrans57")
        completiontrans57 .add_sources(forward5) .add_destinations(print20)
        
        timertrans18 = TimerTrans(1) .set_name("timertrans18")
        timertrans18 .add_sources(print20) .add_destinations(check_cube_pose_valid)
        
        failuretrans46 = FailureTrans() .set_name("failuretrans46")
        failuretrans46 .add_sources(roll1) .add_destinations(try_again)
        
        completiontrans58 = CompletionTrans() .set_name("completiontrans58")
        completiontrans58 .add_sources(roll2) .add_destinations(setliftheight4)
        
        completiontrans59 = CompletionTrans() .set_name("completiontrans59")
        completiontrans59 .add_sources(setliftheight4) .add_destinations(forwardtocube1)
        
        completiontrans60 = CompletionTrans() .set_name("completiontrans60")
        completiontrans60 .add_sources(forwardtocube1) .add_destinations(roll1)
        
        failuretrans47 = FailureTrans() .set_name("failuretrans47")
        failuretrans47 .add_sources(roll2) .add_destinations(try_again)
        
        completiontrans61 = CompletionTrans() .set_name("completiontrans61")
        completiontrans61 .add_sources(roll3) .add_destinations(setliftheight5)
        
        completiontrans62 = CompletionTrans() .set_name("completiontrans62")
        completiontrans62 .add_sources(setliftheight5) .add_destinations(forwardtocube2)
        
        completiontrans63 = CompletionTrans() .set_name("completiontrans63")
        completiontrans63 .add_sources(forwardtocube2) .add_destinations(roll2)
        
        failuretrans48 = FailureTrans() .set_name("failuretrans48")
        failuretrans48 .add_sources(roll3) .add_destinations(try_again)
        ...
        failuretrans49 .add_sources(try_again) .add_destinations(fail)
        
        completiontrans64 = CompletionTrans() .set_name("completiontrans64")
        completiontrans64 .add_sources(fail) .add_destinations(parentfails10)
