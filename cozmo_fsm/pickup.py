...
class GoToCube(StateNode):
    ...
    def setup(self):
        """
            start: SetLiftHeight(0) =T(0.5)=> check_start    # time for vision to set up world map
        ...
        # Code generated by genfsm on Sat Aug  5 04:36:54 2017:
        
        start = SetLiftHeight(0) .set_name("start") .set_parent(self)
        ...
        timertrans1 .add_sources(start) .add_destinations(check_start)
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        ...
        completiontrans12 .add_sources(raise_lift) .add_destinations(statenode1)
        
        timertrans8 = TimerTrans(0.5) .set_name("timertrans8")
        timertrans8 .add_sources(statenode1) .add_destinations(storeimagepatch2)
