...
class GoToCube(StateNode):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Tue Sep 24 11:16:01 2019:
...
class RollingCube(StateNode):
    ...
    class TryAgain(StateNode):
        def start(self, event=None):
            ...
            if self.parent.try_number > 2:
                ...
                self.parent.try_number += 1
                print('try again', self.parent.try_number)
                self.post_success()
    ...
    def setup(self):
        ...
        completiontrans39 .add_sources(print17) .add_destinations(roll1)
        ...
        completiontrans40 .add_sources(print18) .add_destinations(roll2)
        ...
        completiontrans41 .add_sources(print19) .add_destinations(roll3)
        
        completiontrans42 = CompletionTrans() .set_name("completiontrans42")
        completiontrans42 .add_sources(roll1) .add_destinations(check_orientation)
        ...
        completiontrans43 .add_sources(roll2) .add_destinations(roll1)
        ...
        completiontrans44 .add_sources(roll3) .add_destinations(roll2)
        ...
        completiontrans45 .add_sources(fail) .add_destinations(parentfails4)
