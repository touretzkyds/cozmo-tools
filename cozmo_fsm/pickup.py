...
class GoToCube(StateNode):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Fri Jan 19 04:07:22 2018:
    ...
    def setup(self):
        """
            ...
            goto_cube =C=> AbortAllActions() # clear head and lift tracks
              =C=> SetCarrying() =C=> {raise_lift, raise_head}
        ...
        completiontrans13 .add_sources(abortallactions1) .add_destinations(setcarrying1)
        
        completiontrans14 = CompletionTrans() .set_name("completiontrans14")
        completiontrans14 .add_sources(setcarrying1) .add_destinations(raise_lift,raise_head)
        ...
        completiontrans17 .add_sources(final_raise,drop_head) .add_destinations(parentcompletes1)
        ...
        completiontrans20 .add_sources(drop_lift,drop_head_low) .add_destinations(parentfails4)
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        nulltrans5 .add_sources(remembercarriedobject1) .add_destinations(setliftheight1)
        ...
        nulltrans6 .add_sources(setnotcarrying1) .add_destinations(setposition1)
        
        nulltrans7 = NullTrans() .set_name("nulltrans7")
        nulltrans7 .add_sources(setposition1) .add_destinations(forward4)
        
        completiontrans22 = CompletionTrans() .set_name("completiontrans22")
        completiontrans22 .add_sources(forward4) .add_destinations(parentcompletes2)
