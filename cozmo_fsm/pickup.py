...
class GoToCube(StateNode):
    ...
    class TryAllSides(StateNode):
        ...
        def start(self, event=None):
            ...
            if self.parent.try_number > 2:
                ...
                self.post_failure()
                print('Havn\'t tired out all sides of cube. Going to try the side', self.parent.side_index)
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Wed Dec 26 19:27:40 2018:
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        failuretrans15 .add_sources(check_carrying) .add_destinations(parentcompletes3)
