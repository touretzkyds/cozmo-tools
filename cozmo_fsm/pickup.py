...
class GoToCube(StateNode):
    ...
    def setup(self):
        """
            droplift: SetLiftHeight(0) =C=> StateNode() =T(0.5)=>    # allow time for vision to set up world map
        ...
        # Code generated by genfsm on Mon Mar 26 06:47:07 2018:
        ...
        completiontrans1 .add_sources(droplift) .add_destinations(statenode1)
        
        timertrans1 = TimerTrans(0.5) .set_name("timertrans1")
        timertrans1 .add_sources(statenode1) .add_destinations(looker,check_almost_docked_0)
        ...
        completiontrans2 .add_sources(forward1) .add_destinations(statenode2)
        
        timertrans3 = TimerTrans(0.5) .set_name("timertrans3")
        timertrans3 .add_sources(statenode2) .add_destinations(check_start)
        ...
        completiontrans5 .add_sources(forward2) .add_destinations(statenode3)
        
        timertrans8 = TimerTrans(1) .set_name("timertrans8")
        timertrans8 .add_sources(statenode3) .add_destinations(go_cube2)
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        ...
        raise_head = SetHeadAngle(28) .set_name("raise_head") .set_parent(self)
        ...
        failuretrans7 .add_sources(verify) .add_destinations(statenode4)
        ...
        failuretrans8 .add_sources(verify2) .add_destinations(statenode5)
        
        timertrans12 = TimerTrans(0.5) .set_name("timertrans12")
        timertrans12 .add_sources(statenode5) .add_destinations(verify3)
        ...
        nulltrans6 .add_sources(frustrated) .add_destinations(animationtriggernode1)
        ...
        completiontrans22 .add_sources(backupmore,drop_head_low) .add_destinations(parentfails4)
...
class DropObject(StateNode):
    ...
    def setup(self):
        ...
        nulltrans7 .add_sources(setnotcarrying1) .add_destinations(forward4)
