...
class GoToCube(StateNode):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Tue Dec 31 04:56:00 2019:
...
class PickUpCube(StateNode):
    ...
    def setup(self):
        ...
        nulltrans22 .add_sources(goto_cube_pilot) .add_destinations(pilot_frustrated)
...
class RollingCube(StateNode):
    ...
    def setup(self):
        ...
        completiontrans48 .add_sources(check_orientation) .add_destinations(parentcompletes5)
        ...
        completiontrans49 .add_sources(goto_cube) .add_destinations(print14)
        ...
        completiontrans50 .add_sources(print15) .add_destinations(check_cube_pose_valid)
        ...
        completiontrans51 .add_sources(print16) .add_destinations(roll1)
        ...
        completiontrans52 .add_sources(print17) .add_destinations(roll2)
        ...
        completiontrans53 .add_sources(print18) .add_destinations(roll3)
        
        completiontrans54 = CompletionTrans() .set_name("completiontrans54")
        completiontrans54 .add_sources(check_cube_pose_valid) .add_destinations(check_orientation)
        ...
        completiontrans55 .add_sources(setup_check_again) .add_destinations(print19)
        ...
        completiontrans56 .add_sources(check_cube_pose_valid2) .add_destinations(check_orientation)
        ...
        completiontrans57 .add_sources(roll1) .add_destinations(forward5)
        
        completiontrans58 = CompletionTrans() .set_name("completiontrans58")
        completiontrans58 .add_sources(forward5) .add_destinations(print20)
        ...
        completiontrans59 .add_sources(roll2) .add_destinations(setliftheight4)
        
        completiontrans60 = CompletionTrans() .set_name("completiontrans60")
        completiontrans60 .add_sources(setliftheight4) .add_destinations(forwardtocube1)
        
        completiontrans61 = CompletionTrans() .set_name("completiontrans61")
        completiontrans61 .add_sources(forwardtocube1) .add_destinations(roll1)
        ...
        completiontrans62 .add_sources(roll3) .add_destinations(setliftheight5)
        
        completiontrans63 = CompletionTrans() .set_name("completiontrans63")
        completiontrans63 .add_sources(setliftheight5) .add_destinations(forwardtocube2)
        
        completiontrans64 = CompletionTrans() .set_name("completiontrans64")
        completiontrans64 .add_sources(forwardtocube2) .add_destinations(roll2)
        ...
        completiontrans65 .add_sources(fail) .add_destinations(parentfails10)
