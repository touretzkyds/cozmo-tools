...
from .path_planner import PathPlannerProcess
...
class PilotBase(StateNode):
    ...
    class PilotExecutePlan(StateNode):
        ...
        def setup(self):
            ...
            # Code generated by genfsm on Thu Oct  3 04:36:49 2019:
...
class PilotToPose(PilotBase):
    ...
    class PilotPlanner(StateNode):
        ...
        def start(self,event=None):
            ...
            doors = self.robot.world.generate_doorway_list()
            navplan = NavPlan.from_path(path, doors)
