    ...
    class PilotExecutePlan(StateNode):
        ...
        class ExecuteBackup(Forward):
            def start(self, event=None):
                ...
                xy_pair = step.param[0]
                dx = xy_pair[0] - self.robot.world.particle_filter.pose[0]
                dy = xy_pair[1] - self.robot.world.particle_filter.pose[1]
        ...
        def setup(self):
            ...
            # Code generated by genfsm on Mon Nov  4 03:52:40 2019:
