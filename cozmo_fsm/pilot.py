...
class PilotBase(StateNode):
    ...
    class PilotExecutePlan(StateNode):
        ...
        def setup(self):
            ...
            # Code generated by genfsm on Tue Aug 20 23:17:59 2019:
...
class PilotToObject(PilotBase):
    ...
    def setup(self):
        ...
        planner = PathPlanner() .set_name("planner") .set_parent(self)
        ...
        datatrans5 .add_sources(planner) .add_destinations(exec)
...
class PilotToPose(PilotBase):
    ...
    def setup(self):
        ...
        datatrans6 .add_sources(planner) .add_destinations(exec)
