...
class DoorPass(StateNode):
    ...
    def calculate_gate(start_point, door, offset):
        ...
        print('dist1sq=',dist1sq,'  pt1=',(pt1x,pt1y),'\n   dist2sq=',dist2sq,'  pt2=',(pt2x,pt2y))
        if dist1sq < dist2sq:
    ...
    class DriveThrough(Forward):
        ...
        def start(self,event=None):
            (rx, ry, rtheta) = self.robot.world.particle_filter.pose_estimate()
            (gate_x, gate_y, gate_theta) = DoorPass.calculate_gate((rx,ry), self.parent.object, 0)
            dist = sqrt((gate_x-rx)**2 + (gate_y-ry)**2)
            offset = 120
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Fri Dec 13 20:50:07 2019:
