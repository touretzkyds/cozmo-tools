...
class DoorPass(StateNode):
    ...
    def calculate_gate(robot,door,offset):
        """Returns closest gate point (gx, gy)"""
        (rx,ry,_) = robot.world.particle_filter.pose
        dx = door.x
        dy = door.y
        dtheta = door.theta
    ...
    class TurnToGate(Turn):
        ...
        def start(self,event=None):
            ...
            (gate_x, gate_y, _) = DoorPass.calculate_gate(self.robot,self.parent.object,self.offset)
    ...
    def setup(self):
        """
            ...
            turn_to_gate2: self.TurnToGate(DoorPass.INNER_GATE_DISTANCE) =C=>
                StateNode() =T(0.2)=> turn_to_marker1
        ...
        # Code generated by genfsm on Mon Jul 22 03:16:57 2019:
        ...
        completiontrans5 .add_sources(turn_to_marker1) .add_destinations(marker_forward1)
        ...
        completiontrans6 .add_sources(marker_forward1) .add_destinations(setheadangle2)
        ...
        completiontrans8 .add_sources(turn_to_marker2) .add_destinations(marker_forward2)
