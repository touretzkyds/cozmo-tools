...
class DoorPass(StateNode):
    ...
    def setup(self):
        """
            ...
            marker_forward1: self.ForwardToGate(70) =C=> SetHeadAngle(40) =C=>
        ...
        # Code generated by genfsm on Fri May 10 21:05:50 2019:
        ...
        marker_forward1 = self.ForwardToGate(70) .set_name("marker_forward1") .set_parent(self)
