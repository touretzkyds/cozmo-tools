...
class DoorPass(StateNode):
    ...
    class TurnToMarker(Turn):
        ...
        def start(self,event=None):
            ...
            if abs(turn) < 2*pi/180:
                ...
                self.angle = Angle(radians=turn)
            print("TurnTOMarker turning by %.1f degrees" % turn*180/pi)
            super().start(event)
    ...
    def setup(self):
        """
            ...
            turn_to_gate2: self.TurnToMarker() # self.TurnToGate(70)
        ...
        # Code generated by genfsm on Tue Jan  8 04:13:49 2019:
        ...
        turn_to_gate2 = self.TurnToMarker() .set_name("turn_to_gate2") .set_parent(self)
